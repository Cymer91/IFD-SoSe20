window.addEventListener("load", function () {
	document.querySelector('.vui-go').addEventListener("click", function () {
		...
		artyom.addCommands([
			...
			{
				indexes: ["haki bitte checke meinen HFU Webmail Account", "Haki bitte checke meine HFU Webmail Account", "Haki bitte checke meinen HFU Webmail Account"],
				action: function () {
			...
			},
			{
				...
				{
				indexes: ["Danke, Haki", "danke Hatschi", "danke harki", "danke Haki"],
				action: function () {
					document.getElementById('in').innerHTML ="Bitte, Marcel. Kann ich sonst noch etwas für dich tun?";
					artyom.say("Bitte, Marcel. Kann ich sonst noch etwas für dich tun?");
				}
			},
			{
			...
			{
				indexes: ["wo finde ich die Aufgabenstellung für die Abgabe in Streaminganwendungen", "wo finde ich die Aufgabenstellung für die Abgabe in stream mir Anwendungen", "wo finde ich die Aufgabenstellung für die Abgabe in Streaming Anwendungen", "wo finde ich die Aufgabenstellung für die Aufgabe in Streaming Anwendungen"],
				action: function (i) {
